<?php $__env->startSection('content'); ?>
 ...
 <div class="right_col" role="main">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="isbn" placeholder="<?php echo e($data->Kode_lembur); ?>" readonly>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <a href="<?php echo e(url('Kategori')); ?>" class="btn btn-primary">Back</a>
            </div>
        </div>
    </form>
                  </div>
