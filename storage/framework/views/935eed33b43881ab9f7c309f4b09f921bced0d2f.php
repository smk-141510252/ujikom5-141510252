<?php $__env->startSection('content'); ?>
 ...
 <div class="right_col" role="main">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="isbn" placeholder="<?php echo e($data->Kode_jabatan); ?>" readonly>
            </div>
        </div>
        <div class="form-group">
            <label for="isbn" class="col-sm-2 control-label">Nama Jabatan</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="isbn" placeholder="<?php echo e($data->Nama_jabatan); ?>" readonly>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <a href="<?php echo e(url('Jabatan')); ?>" class="btn btn-primary">Back</a>
            </div>
        </div>
    </form>
                  </div>
