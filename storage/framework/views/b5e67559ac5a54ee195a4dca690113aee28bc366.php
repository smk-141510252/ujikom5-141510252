...
<br>
 ...
 &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('Lembur/create')); ?>" class="btn btn-info">Input Lembur Pegawai&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
            <div class="row">
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $lembur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Lembur',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye">Ubah</i></a></th>

                                 <th><a title="Edit" href="<?php echo e(route('Lembur.edit',$data->id)); ?>" class="btn btn-warning">Lihat<i class="fa fa-edit"></i></a></th>
