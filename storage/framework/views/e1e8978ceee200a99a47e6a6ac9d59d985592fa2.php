                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $penggajian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Penggajian',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye">Ubah</i></a></th>

                                 <th><a title="Edit" href="<?php echo e(route('Penggajian.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit">Lihat</i></a></th>
