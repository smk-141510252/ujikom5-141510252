...
<br>
 ...
 &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('Tunjangan/create')); ?>" class="btn btn-success">Input Data Tunjangan&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><center>Daftar Tunjangan</h2></center>
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $tunjangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Tunjangan',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye">Ubah</i></a></th>
                                 <th><a title="Edit" href="<?php echo e(route('Tunjangan.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit">Lihat</i></a></th>
                                 <th>
