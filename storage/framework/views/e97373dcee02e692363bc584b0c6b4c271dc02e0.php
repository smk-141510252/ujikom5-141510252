            ...
            <div class="row">
                ...
                <?php if(Auth::guest()): ?>
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills"> <b><?php echo e(Auth::user()->name); ?></b> , Anda Memilih Kategori Lembur</span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<br>
 ...
 &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('Kategori/create')); ?>" class="btn btn-success">Input Kategori Lembur&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
            <div class="row">
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Kategori',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye">Úbah</i></a></th>

                                 <th><a title="Edit" href="<?php echo e(route('Kategori.edit',$data->id)); ?>" class="btn btn-warning">Lihat<i class="fa fa-edit"></i></a></th>
