...
<br>
 ...
 &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('TunjanganP/create')); ?>" class="btn btn-warning">Input Tunjangan Pegawai&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
            <div class="row">
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $tp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('TunjanganP',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye">Ubah</i></a></th>
                                 
                                 <th><a title="Edit" href="<?php echo e(route('TunjanganP.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit">Lihat</i></a></th>
                                 <th>
