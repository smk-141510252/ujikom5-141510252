...
<br>
 ...
 &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('Golongan/create')); ?>" class="btn btn-danger">Input Data Golongan&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
            <div class="row">
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $gol; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Golongan',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye">Ubah</i></a></th>

                                 <th><a title="Edit" href="<?php echo e(route('Golongan.edit',$data->id)); ?>" class="btn btn-warning">Lihat<i class="fa fa-edit"></i></a></th>
