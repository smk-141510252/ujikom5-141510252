                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Jabatan',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></th>
                                 <th><a title="Edit" href="<?php echo e(route('Jabatan.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a></th>
                                 <th>
