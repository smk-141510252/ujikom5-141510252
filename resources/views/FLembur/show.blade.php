...
@section('content')
 ...
 <div class="right_col" role="main">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="isbn" placeholder="{{$data->Kategori_lembur->Kode_lembur}}" readonly>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="isbn" placeholder="{{$data->Jumlah_jam}}" readonly>
            </div>
        </div>
        <div class="form-group">
