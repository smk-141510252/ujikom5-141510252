            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
    {!! Form::model($data,['method' => 'PATCH','route'=>['Tunjangan.update',$data->id],'class' => 'form-horizontal form-label-left']) !!}
    <div id="pegawai">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <h4 class="text-danger"><?php echo '<br><br>'.$errors->first('Status', '<p>Form input harus diisi!!</p>') ?></h4>
          </div>
      </div>
      <div class="form-group">
          <div class="control-label col-md-3 col-sm-3 col-xs-12">
